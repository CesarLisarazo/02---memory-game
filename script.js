...
Swal.fire({
    ...
    html:  " <br><br><br><br><span class='homeText'><span><br><button id='homeSound'>Sound: Off</button><br><br><span class='homeText'><span><br><button id='homeIdiom'>English</button><br><br>",
